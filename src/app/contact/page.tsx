    ...
    <main>
      <section className="min-h-[80vh] bg-[radial-gradient(circle_at_15%_15%,rgba(56,189,248,.24),transparent_34%),linear-gradient(135deg,#020617,#07111f_55%,#111827)] px-5 pb-20 pt-40">
        <div className="mx-auto max-w-7xl">
          <div className="text-sm font-black uppercase tracking-[0.25em] text-giuva-cyan">Contact GIUVA.RO</div>
          <h1 className="mt-5 max-w-5xl text-5xl font-black leading-none md:text-8xl">Let’s build response together.</h1>
